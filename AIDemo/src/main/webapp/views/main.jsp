...
<head>
  ...
  <base href="<%=basePath%>">
  <title>数字管理系统主页</title>
  <link rel="stylesheet" type="text/css" href="resources/css/style.css" />
  <link rel="stylesheet" type="text/css" href="resources/css/skin_/main.css" />
  <link rel="stylesheet" type="text/css" href="resources/css/jquery.dialog.css" />
...
<div id="container">
    ...
    <div id="bd">
        <iframe width="100%" height="100%" id="mainIframe" src="views/nav.jsp" frameborder="0"></iframe>
    </div>
